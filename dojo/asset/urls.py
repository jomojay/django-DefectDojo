...
if settings.ENABLE_V3_ORGANIZATION_ASSET_RELABEL:
    urlpatterns = [
        ...
        re_path(
            r"^asset/(?P<pid>\d+)/authorized_users/add$",
            views.add_product_authorized_users,
            name="add_product_authorized_users",
        ),
        re_path(
            r"^asset/(?P<pid>\d+)/authorized_users/(?P<user_id>\d+)/delete$",
        ...
        re_path(r"^product/(?P<pid>\d+)/authorized_users/add$", redirect_view("add_product_authorized_users")),
        re_path(r"^product/(?P<pid>\d+)/authorized_users/(?P<user_id>\d+)/delete$", redirect_view("delete_product_authorized_user")),
    ...
    urlpatterns = [
        ...
        re_path(r"^asset/(?P<pid>\d+)/authorized_users/add$", redirect_view("add_product_authorized_users")),
        re_path(r"^asset/(?P<pid>\d+)/authorized_users/(?P<user_id>\d+)/delete$",
                redirect_view("delete_product_authorized_user")),
